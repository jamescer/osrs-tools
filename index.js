exports.json = function () {
    ...
    return {
        ...
        "Another Slice of H.A.M.": {
            ...
            "Length": "Medium",
            "requirements": {
                "quests": ["Death to the Dorgeshuun", "The Giant Dwarf", "The Dig Site", "Druidic Ritual"],
                "levels": [{
                    "skill": "attack",
                    "level": 15,
                    "boostable": false
        ...
        "Devious Minds": {
            ...
            "Length": "Short",
            "requirements": {
                "quests": ["Wanted!", "Troll Stronghold", "Doric's Quest", "Enter the Abyss"],
                "levels": [{
                    "skill": "smithing",
                    "level": 65,
                    "boostable": true
        ...
        "Making Friends with My Arm": {
            ...
            "Length": "Medium",
            "requirements": {
                "quests": ["My Arm's Big Adventure", "Swan Song", "Cold War", "Romeo & Juliet"],
                "levels": [{
                    "skill": "firemaking",
                    "level": 66,
                    "boostable": false
        ...
        "Monkey Madness II": {
            ...
            "Length": "Very long",
            "requirements": {
                "quests": ["Enlightened Journey", "The Eyes of Glouphrie", "Recipe for Disaster", "Troll Stronghold", "Watchtower"],
                "levels": [{
                    "skill": "slayer",
                    "level": 69,
                    "boostable": false
        ...
        "Recipe for Disaster": {
            ...
            "Length": "Very long",
            "requirements": {
                "quests": ["Cook's Assistant", "Fishing Contest", "Goblin Diplomacy", "Big Chompy Bird Hunting", "Murder Mystery", "Nature Spirit", "Witch's House", "Gertrude's Cat", "Shadow of the Storm", "Started Legends' Quest", "Monkey Madness I", "Desert Treasure", "Horror from the Deep"],
                "levels": [{
                    "skill": "quest",
                    "level": 175,
                    "boostable": false
        ...
        "The Great Brain Robbery": {
            ...
            "Length": "Medium",
            "requirements": {
                "quests": ["Creature of Fenkenstrain", "Cabin Fever", "Pirate Pete subquest of Recipe for Disaster"],
                "levels": [{
                    "skill": "crafting",
                    "level": 16,
                    "boostable": false
        ...
        "Sins of the Father": {
            ...
            "Rewards": {
                ...
                "other": ["Access to Darkmeyer", "A tome of experience, granting 15,000 experience to any three skills (level 60 or higher). Can be the same skill.", "Darkmeyer teleport via Drakan's medallion", "Boat travel between Burgh de Rott, Slepe and the Icyene Graveyard"]
            }
        },
        "The Slug Menace": {
            "Miniquest": false,
        ...
        "Vampire Slayer": {
            "Miniquest": false,
            "Name": "Vampire Slayer",
            "url": "https://oldschool.runescape.wiki/w/Vampire_Slayer",
            "members": false,
            "Difficulty": "Novice",
            "Length": "Short",
            "requirements": {
        ...
        "Wanted!": {
            ...
            "Length": "Long",
            "requirements": {
                "quests": ["Recruitment Drive", "Rune Mysteries", "The Lost Tribe", "Priest in Peril"],
                "levels": [{
                    "skill": "quest",
                    "level": 32,
                    "boostable": false
        ...
        "X Marks the Spot": {
            ...
            "Rewards": {
                "Experience": [],
                "QuestPoints": 1,
                "other": ["200 coins", "Antique lamp which provides 300 XP in a skill of the player's choosing.", "A beginner clue scroll (only if the player does not have one in their possession; can be claimed later if players had one in their possession already)"]
            },
            "Series": "Great Kourend"
        },
        "Zogre Flesh Eaters": {
