...
// Diagnostic script: perform GET to candidate sources and print status + headers
...
(async ()=>{
  for (const id of ids){
    ...
    for (const s of sources){
      ...
      console.log(JSON.stringify(r, Object.keys(r).length?Object.keys(r):[],2));
    }
  }
})();
