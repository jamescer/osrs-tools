...
const questData = require('./Quest/data/questData.js.js');
const questDataArray = require('./Quest/data/questDataArray.js.js');
const subQuestArray = require('./Quest/data/subQuestArray.js.js');
      ...
      for (var y in quest.subquests) {
        ...
        if (
          this.canCompleteQuest(
            this.questObject[quest.requirements.subquests[y]]
          ) != true
        ) {
          return false;
        }
