...
const AnimalMagnetism: Quest = {
  age: 'Fifth Age',
  description:
    'Help bury the restless dead by collecting a variety of bones and skulls scattered across Gielinor. Investigate a sinister force manipulating these undead creatures.',
