...
const TheGreatBrainRobbery: Quest = {
  age: 'Fifth Age',
  description:
    "Travel to the island of Mos Le'Harmless and uncover a mad scientist plot involving mind control and theft of consciousness. Stop the nefarious experiments.",
