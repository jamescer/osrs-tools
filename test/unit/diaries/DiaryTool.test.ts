...
import { CombatLevelRequirement, LevelRequirement, QuestPointRequirement, QuestRequirement } from "src/runescape/model/Requirement";
...
const metSkillTask: DiaryTask = { description: "Requires Herblore 85", requirements: [new LevelRequirement("Herblore", 85, false)] };
const unmetSkillTask: DiaryTask = { description: "Requires Agility 90", requirements: [new LevelRequirement("Agility", 90, false)] };
const boostableMetTask: DiaryTask = { description: "Requires Agility 88 (boostable)", requirements: [new LevelRequirement("Agility", 88, true)] };  // 84 + 5 boost = 89 >= 88
const boostableUnmetTask: DiaryTask = { description: "Requires Agility 90 (boostable)", requirements: [new LevelRequirement("Agility", 90, true)] }; // 84 + 5 = 89 < 90
const combatMetTask: DiaryTask = { description: "Requires combat 100", requirements: [new CombatLevelRequirement(100)] };
const combatUnmetTask: DiaryTask = { description: "Requires combat 130", requirements: [new CombatLevelRequirement(130)] };
...
const questTask: DiaryTask = { description: "Requires Rune Mysteries", requirements: [new QuestRequirement("Rune Mysteries")] };
