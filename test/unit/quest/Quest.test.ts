...
import { ItemRequirement, LevelRequirement } from "../../../source/runescape/model/Requirement";
...
describe("Quest Rewards Structure", () => {
  it("should support the new QuestRewards experience array structure", () => {
    const quest: Quest = {
      ...
      requirements: [new ItemRequirement("Bucket of milk"), new ItemRequirement("Pot of flour"), new ItemRequirement("Egg"), new LevelRequirement("cooking", 10, true)],
      rewards: {
        areas: ["Lumbridge"],
        experience: [
