...
describe('Quest - OSRS Quest system', () => {
  describe('Quest basic structure', () => {
    ...
    it('should support all quest length values', () => {
      const lengths = [QuestLength.Short, QuestLength.Medium, QuestLength.Long, QuestLength.VeryLong];
      ...
      const quest = {
        ...
        rewards: {
          ...
          items: [
            ...
            { name: 'Coins', note: 'untradeable', quantity: 5000 },
          ],
          lamps: [],
          pets: [],
          points: [],
    ...
    it('should support lamps in rewards', () => {
      const quest = {
        ...
        rewards: {
          ...
          experience: [],
          items: [],
          lamps: [{ amount: 10000, skillRestriction: 'magic' }, { amount: 5000 }],
          pets: [],
          points: [],
          questPoints: 1,
          unlocks: [],
  ...
  describe('Quest requirements', () => {
    it('should support item requirements', () => {
      const quest = {
        ...
        recommendedPrayers: [],
        recommendedSkills: {},
        requirements: [new ItemRequirement('Bucket of milk', 1), new ItemRequirement('Pot of flour', 1)],
        rewards: { questPoints: 1 },
        shortName: 'item_req',
        startLocation: 'Lumbridge',
        status: QuestStatus.NotStarted,
  ...
  describe('Quest status', () => {
    it('should support all quest status values', () => {
      const statuses = [QuestStatus.NotStarted, QuestStatus.InProgress, QuestStatus.Complete];
  ...
  describe('Edge cases and special scenarios', () => {
    ...
    it('should handle quests with multiple experience rewards', () => {
      ...
      const totalExp = quest.rewards.experience?.reduce((sum, exp) => sum + exp.amount, 0);
