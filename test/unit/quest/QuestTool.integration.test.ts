...
describe('QuestTool Integration Tests', () => {
  ...
  describe('Skill-based Quest Filtering', () => {
    ...
    it('should find beginner quests easily', () => {
      const beginner = ['Tutorial Island', 'Learning the Ropes', 'Sheep Shearer', "Cook's Assistant", 'Rune Mysteries'];
  ...
  describe('Quest Length Distribution', () => {
    ...
    it('should have quests with varying lengths', () => {
      ...
      const shortQuestCount = allQuests.filter(q => q.length === 'Very short' || q.length === 'Short').length;
  ...
  describe('Special Quests', () => {
    ...
    it('should handle quests with special characters in names', () => {
      const specialNames = ["Witch's Potion", 'The Curse of Arrav', 'A Kingdom Divided', 'The Fremennik Exiles'];
