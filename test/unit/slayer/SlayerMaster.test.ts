...
describe("SlayerMaster", () => {
  const mockTasks: Task[] = [new Task("Banshee", 0, 15, [], null, null, [], 5), new Task("Cave Crawler", 0, 15, [], null, null, [], 3), new Task("Crawling Hand", 0, 15, [], null, null, [], 2)];
  const taskPoints = { 1: 2, 10: 10, 50: 50 };
  const eliteDiaryTaskPoints = { 1: 3, 10: 15, 50: 75 };
  const master = new SlayerMaster("Test Master", mockTasks, "Testville", 50, "https://wiki.test/Test_Master", taskPoints, eliteDiaryTaskPoints);
