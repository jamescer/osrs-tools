...
import { CombatLevelRequirement, ItemRequirement, SlayerLevelRequirement } from 'src/runescape/model/Requirement';
import { Assignment } from 'src/runescape/model/slayer/Assignment';
...
describe('Assignment - Active slayer task assignment', () => {
  ...
  describe('constructor and basic properties', () => {
    ...
    it('should create assignment with extended amounts', () => {
      const assignment = new Assignment('Extended Task', 20, mockRequirements, 30, 50);
  ...
  describe('getter methods', () => {
    ...
    beforeEach(() => {
      assignment = new Assignment('Test Creature', 15, [new SlayerLevelRequirement(60)], 20, 30);
    });
  ...
  describe('task conversions', () => {
    ...
    it('should maintain requirements through assignment', () => {
      const requirements = [new SlayerLevelRequirement(85), new CombatLevelRequirement(75)];
  ...
  describe('assignment with various requirements', () => {
    it('should create assignment with slayer level requirement', () => {
      const assignment = new Assignment('Slayer Task', 20, [new SlayerLevelRequirement(75)]);

      expect(assignment.requirements.length).toBe(1);
    });

    it('should create assignment with combat level requirement', () => {
      const assignment = new Assignment('Combat Task', 30, [new CombatLevelRequirement(80)]);
  ...
  describe('realistic assignment scenarios', () => {
    ...
    it('should represent mid-level master assignment', () => {
      const midLevelAssignment = new Assignment(
        'Dagannoths',
        50,
        [new SlayerLevelRequirement(40), new CombatLevelRequirement(60)],
        75,
        100,
      );
    ...
    it('should represent high-level master assignment', () => {
      const highLevelAssignment = new Assignment(
        'Abyssal demons',
        120,
        [new SlayerLevelRequirement(85), new CombatLevelRequirement(85)],
        200,
        300,
      );
  ...
  describe('extended task amounts', () => {
    it('should store regular and extended amounts', () => {
      const assignment = new Assignment('Task', 100, [], 150, 200);
