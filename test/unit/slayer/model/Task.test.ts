...
describe('Task - Slayer task configuration', () => {
  ...
  describe('constructor', () => {
    ...
    it('should support various task types', () => {
      const taskTypes = [
        { max: 20, min: 10, name: 'Spiders' },
        { max: 30, min: 15, name: 'Goblins' },
        { max: 200, min: 100, name: 'Dragons' },
        { max: 150, min: 75, name: 'Wyverns' },
      ];
  ...
  describe('task requirements', () => {
    ...
    it('should support multiple combat level requirements', () => {
      const combatReqs = [new CombatLevelRequirement(80), new CombatLevelRequirement(75)];
  ...
  describe('wilderness and boss tasks', () => {
    it('should support wilderness level tracking', () => {
      const wildernessTasks = [
        { level: 52, name: 'Lava Dragons' },
        { level: 10, name: 'Revenant NPCs' },
      ];
    ...
    it('should support tasks with multiple locations', () => {
      const task = new Task('Spread Task', 100, 200, [], null, null, [], 3, [123], 500, [
        'Dungeon 1',
        'Dungeon 2',
        'Dungeon 3',
      ]);
  ...
  describe('task variants and alternatives', () => {
    it('should track alternative monster variants', () => {
      const task = new Task('Demons', 100, 200, [new SlayerLevelRequirement(75)], null, null, [
        'Lesser demon',
        'Greater demon',
        'Black demon',
      ]);
  ...
  describe('real-world task examples', () => {
    ...
    it('should create Wyvern task', () => {
      const wyvernTask = new Task('Wyverns', 75, 150, [new SlayerLevelRequirement(72)], 100, 200, [], 6, [104], 200, [
        'Wyvern Cave',
      ]);
